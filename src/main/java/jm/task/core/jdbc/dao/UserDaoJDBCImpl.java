...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void dropUsersTable() {
        final String DROP_TABLE_SQL = "DROP TABLE user;";
    ...
    public void saveUser(String name, String lastName, byte age) {
        final String SAVE_USER_SQL = "INSERT INTO user (name, lastName, age) VALUES (?, ?, ?);";
    ...
    public void removeUserById(long id) {
        final String DELETE_USER_SQL = "DELETE FROM user WHERE id = ?;";
    ...
    public List<User> getAllUsers() {
        ...
        final String GET_ALL_SQL = "SELECT id, name, lastName, age FROM user";
    ...
    public void cleanUsersTable() {
        final String CLEAR_USER_SQL = "DELETE FROM user;";

        try (Connection connection = Util.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(CLEAR_USER_SQL)) {
